...
use turin_channel_core::{
    ...
    ChannelInstallManifest, ChannelKind, ChannelRuntimeCapabilities, ChannelRuntimeManifest,
    ChannelSecretRequirement, ChannelSetupManifest, ChannelUser, ChannelValidationCheck,
    DEFAULT_MAX_INBOUND_TEXT_CHARS, InboundEvent, OutboundMessage,
};
#[cfg(test)]
use turin_channel_core::{ChannelMessageRef, ChannelSessionScope, MessageBlock};
