        ...
        let detail = SessionDetail {
            ...
            branches: vec![
                ...
                SessionBranchDetail {
                    ...
                    source_turn_id: Some(0),
                    origin_kind: "sidestep".to_string(),
                    origin_task_id: Some("task-1".to_string()),
                    origin_execution_id: Some("exec-1".to_string()),
                    origin_metadata: None,
                    active: true,
