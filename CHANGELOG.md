...
- **Rocket.Chat Channel**
  ...
  - Added `dm_session_scope` overrides for Rocket.Chat and Telegram so direct messages can keep a continuous session while shared rooms still use a different scope.
