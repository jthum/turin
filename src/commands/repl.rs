...
pub(crate) async fn run_repl(
    ...
    let mut kernel = crate::commands::tool_authorization::with_interactive_authorization(
        crate::composition::kernel_builder(config),
    )
    .build()?; // JSON not supported in REPL yet
