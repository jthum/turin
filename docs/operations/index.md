...
This section covers running, validating, and operating Turin in practice.

## Pages

- `docs/operations/daemon.md` — daemon model, command surface, runtime lifecycle, and channels
- `docs/operations/remote.md` — network bridge for authenticated HTTP and event streaming on top of the daemon
- `docs/operations/ui-clients.md` — operator workflows for `turin-tui`, `turin-app`, and `turin-web`, including local/remote profiles
- `docs/operations/ui-client-parity.md` — current per-client support matrix for semantic harness UI intent
- `docs/operations/turin-web.md` — current web API/client shape and browser-shell direction
