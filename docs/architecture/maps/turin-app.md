...
selected-row feedback, sorted-column markers, timeline/pause/claim/failure
item context, filtered empty-list copy, editable forms, confirmation modals,
latest action result feedback, shown panes, dynamic UI navigation/focus/refresh
