...
matching, badge-text derivation, action-feedback app-scoping, form field
...
connection profile editing, and deeper inspectors should be reintroduced only
as they fit the new terminal UX model.
